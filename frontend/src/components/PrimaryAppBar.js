...
export default function PrimaryAppBar() {
  ...
  const [logged, setlogged] = React.useState(
    sessionStorage.getItem("logged") !== null
      ? parseInt(sessionStorage.getItem("logged"))
      : 0
  );
  ...
  const handlelogout = () => {
    setlogged(0);
    axios.post(url.concat("logout"), {}).then((res) => {
                    ...
                    <div className={classes.paper}>
                      ...
                      <form className={classes.form}>
                        ...
                        >
                          ...
                          <OutlinedInput
                            onChange={(e) =>
                              setNewRegisterPassword(e.target.value)
                            }
                            variant="outlined"
                            margin="normal"
                            required
                        ...
                        {message !== "" && (
                          <p className={classes.error}>
                            {" "}
                            <CheckCircleIcon color="inherit" /> {" " + message}
                          </p>
                        )}
