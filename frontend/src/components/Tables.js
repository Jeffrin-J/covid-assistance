...
export default function Tables(props) {
  ...
  useEffect(() => {
    console.log(center);
    axios.post(url.concat("postcurrentloc"), center).then((res) => {
      if (res.data) {
        const data = res.data;
        //console.log(data)
        setMarkerData(data);
              ...
              >
                <TableHead>
                  ...
                  <TableRow>
                    ...
                    <StyledTableCell align="center">
                      Non Oxygen Beds Total
                    </StyledTableCell>

                    <StyledTableCell align="center">
                      Non Oxygen Beds Vacant
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      ICU Beds Total
                    </StyledTableCell>
                ...
                <TableBody>
                  {markerdata.map((row) => (
                    <StyledTableRow key={row.place} color="secondary">
                      ...
                      <StyledTableCell align="center">
                        {row.non_oxy_bed_total}
                      </StyledTableCell>

                      <StyledTableCell align="center">
                        {row.non_oxy_bed_vacant}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {row.icu_bed_total}
                      </StyledTableCell>
                      ...
                      <StyledTableCell align="center">
                        {row.covid_bed_vacant === 0 &&
                        row.oxy_bed_vacant === 0 &&
                        row.non_oxy_bed_vacant === 0 &&
                        row.icu_bed_vacant === 0 &&
                        row.vent_bed_vacant === 0 ? (
                          <Button
                            variant="contained"
                            color="secondary"
                            disabled
                          ...
                          <Container component="main" maxWidth="xs">
                            ...
                            <div className={classes.paper}>
                              ...
                              <form className={classes.form}>
                                ...
                                >
                                  {temp[0] && (
                                    <MenuItem value="Covid Bed">
                                      Covid Bed
                                    </MenuItem>
                                  )}
                                  {temp[1] && (
                                    <MenuItem value="Oxygen Bed">
                                      Oxygen beds
                                    </MenuItem>
                                  )}
                                  {temp[2] && (
                                    <MenuItem value="Non oxygen Bed">
                                      Non oxygen Bed
                                    </MenuItem>
                                  )}
                                  {temp[3] && (
                      ...
                      <StyledTableCell align="center">
                        {String(row.contactnumber).length > 5
                          ? row.contactnumber
                          : "-"}
                      </StyledTableCell>
                    </StyledTableRow>
